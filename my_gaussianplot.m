function [lp,rp,kh,kp]=my_gaussianplot(y,m,v,w,a,b)
...
if ~nargout
    switch q
        ...
        case 2,
            ...
            h = surfl(xax,yax,reshape(gaussmixp(reshape(xx,nxx^2,2),m,v,w),nxx,nxx)');
            shading interp
            ...
            if n>0
                ...
                msk=lp>clim*[0.5; 0.5];
                if any(msk)
                    plot(y(msk,1),y(msk,2),'x','markeredgecolor','b');
                end
                if any(~msk)
                    plot(y(~msk,1),y(~msk,2),'x','markeredgecolor','b');
                end
